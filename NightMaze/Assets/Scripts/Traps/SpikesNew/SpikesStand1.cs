...
public class SpikesWhereStands_1 : MonoBehaviour
{

    [SerializeField] public Animator trapAnimator;
    [SerializeField] public string activateAnimationName = "ActivatedStand_1";
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            trapAnimator.SetBool("isActivatedAnimation_1", true);
        }
    }
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        ...
        if (other.CompareTag("Player"))
        {
            trapAnimator.SetBool("isActivatedAnimation_1", false);
        }
    }
    private void Update()
    {
