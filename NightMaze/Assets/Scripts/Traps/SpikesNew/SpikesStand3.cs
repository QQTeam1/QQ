...
public class SpikesWhereStands_3 : MonoBehaviour
{

    [SerializeField] public Animator trapAnimator;
    [SerializeField] public string activateAnimationName = "ActivatedStand_3";
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            trapAnimator.SetBool("isActivatedAnimation_3", true);
        }
    }
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        ...
        if (other.CompareTag("Player"))
        {
            trapAnimator.SetBool("isActivatedAnimation_3", false);
        }
    }
    private void Update()
    {
